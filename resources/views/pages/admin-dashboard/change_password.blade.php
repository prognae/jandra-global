              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1">Change Pasword</h4>
                  </div>
                  ...
                  <form action="/admin/change/password" method="post">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="password" id="form2Example11" name="currentPassword" class="form-control"
                        placeholder="Username" />                     
                    </div>
  
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form2Example22">New Password</label>
                      <input type="password" id="form2Example22" name="newPassword1" class="form-control" placeholder="Password" />                      
                    </div>

                    <div class="form-outline mb-4">
                        <label class="form-label" for="form2Example22">Re-Enter New Password</label>
                        <input type="password" id="form2Example22" name="newPassword2" class="form-control" placeholder="Password" />                      
                      </div>
  
                    <div class="text-center pt-1 mb-5 pb-1">
                      <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" style="padding: 14px 40px; font-size: 18px;">Submit</button>
                    </div>  
                  </form>
