            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="img/llogo.png" alt=""></a>
                    </div>
                </div>
...
<div class="row">
  ...
  <!-- Gallery -->
   ...
   @vite(['resources/js/jquery.nice-select.min.js'])
   @vite(['resources/js/jquery.nicescroll.min.js'])
   @vite(['resources/js/jquery.magnific-popup.min.js'])
   @vite(['resources/js/jquery.countdown.min.js'])
   @vite(['resources/js/jquery.slicknav.js'])
   @vite(['resources/js/mixitup.min.js'])
